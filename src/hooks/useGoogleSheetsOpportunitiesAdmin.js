...
/**
 * Hook to fetch ALL opportunities from Google Sheets (for admin use)
 * Includes drafts, scheduled, and published opportunities
 */
export function useGoogleSheetsOpportunitiesAdmin() {
		...
		try {
			...
			const transformed = data
				...
				.map(opp => {
					...
					const oppStatus = (opp.status || 'published').toLowerCase();
