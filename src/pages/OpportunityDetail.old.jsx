...
import { Calendar, MapPin, BadgeDollarSign, Tag, ArrowRight, Building2, Eye, MessageCircle } from "lucide-react";
		...
		<div className="mx-auto max-w-6xl space-y-8">
			...
			<section className="grid gap-8 lg:grid-cols-[1fr,320px]">
				...
				<article className="space-y-6">
					...
					{/* Premium overview (business formal) */}
					<div className="mt-5">
						<h2 className="text-base font-extrabold uppercase tracking-wide text-gray-900 dark:text-white">
							Opportunity Overview
						</h2>
						<div className="mt-3 grid gap-3 sm:grid-cols-3">
							<div className="rounded-xl border border-red-100 bg-white/60 p-3 text-sm text-gray-900 dark:border-gray-700 dark:bg-white/5 dark:text-white">
								<div className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Funding</div>
								<div className="mt-1 font-bold">{amount}</div>
							</div>
							<div className="rounded-xl border border-red-100 bg-white/60 p-3 text-sm text-gray-900 dark:border-gray-700 dark:bg-white/5 dark:text-white">
								<div className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Deadline</div>
								<div className="mt-1 font-bold">{deadline}</div>
							</div>
							<div className="rounded-xl border border-red-100 bg-white/60 p-3 text-sm text-gray-900 dark:border-gray-700 dark:bg-white/5 dark:text-white">
								<div className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Location</div>
								<div className="mt-1 font-bold">{opp.region}{opp.country ? ` • ${opp.country}` : ""}</div>
							</div>
						</div>
					</div>
					<div className="mt-5 space-y-4 text-[15px] leading-relaxed text-gray-800 dark:text-gray-200">
						<p>
						...
						<p>
							Eligibility spans early to growth‑stage MSMEs with demonstrable traction. Emphasis is placed on inclusivity,
							climate‑smart solutions, and localized value chains.
						</p>
					</div>
