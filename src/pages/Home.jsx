		...
		<div className="space-y-10">
						...
						<ul className="divide-y divide-gray-200 dark:divide-gray-800">
							{sideHeadlines.map((h) => (
								<li key={h.url} className="py-3">
									<a href={h.url} className="group block">
				...
				<SectionHeader
                    ...
                    action={
                        <div className="flex items-center gap-3">
                            ...
                            <a href="/contact" className="text-sm font-semibold text-gray-700 hover:text-primary dark:text-gray-300">
                                Submit a Story
                            </a>
                        </div>
                    }
							...
							<ul className="divide-y divide-gray-200 dark:divide-gray-800">
								{funding.slice(1, 6).map((a) => (
									<li key={a.url} className="py-3">
										<a href={a.url} className="group flex items-start gap-3">
											<img
												src={a.image}
												alt={a.title}
			...
			<section className="grid gap-4 sm:grid-cols-2">
				...
				>
					...
					<div className="mt-2 text-xs text-white/80">Have an opportunity? <a className="underline" href="/contact">Submit it</a></div>
				</a>
				<a
				...
				>
					...
					<div className="mt-2 text-xs text-white/80">Have a tender? <a className="underline" href="/contact">Post it</a></div>
				</a>
			</section>
		</div>
	);
